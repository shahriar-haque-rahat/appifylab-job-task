      ...
      <div className="_layout_right_sidebar_inner">
        <div className="_right_inner_area_info _padd_t24  _padd_b24 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
          ...
          <div className="_right_inner_area_info_ppl">
            ...
            <div className="_right_info_btn_grp mt-4 gap-2.5">
              <button
                type="button"
                className="_right_info_btn_link mx-0! flex-1 whitespace-nowrap px-4!"
              >
                Ignore
              </button>
              <button
                type="button"
                className="_right_info_btn_link _right_info_btn_link_active mx-0! flex-1 whitespace-nowrap px-4!"
              >
                Follow
              </button>
            </div>
